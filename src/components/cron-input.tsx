...
export interface CronInputProps {
  ...
  promptToCron?: (prompt: string) => Promise<string> // Already optional with ?
  showSeconds?: boolean // Add this new prop
  theme?: {
    baseColor?: string
    primaryColor?: string
...
export function CronInput({
  ...
  layout = "cron-native",
  promptToCron, // Remove the default mock function
  showSeconds = true, // Add this with default true
  theme = {
  ...
  const handleCustomChange = (expression: string) => {
    ...
    } else if (parsed.dayOfWeek !== "*" && parsed.dayOfWeek !== "" && parsed.dayOfWeek !== "?" && parsed.day === "?") {
      ...
      <PopoverTrigger asChild>
        ...
        >
          <span className="truncate">
            {validation.isValid && currentDescription !== "Invalid cron expression" ? currentDescription : placeholder}
          </span>
          ...
          <div className="p-4">
            ...
            <TabsContent value="builder" className="mt-0 space-y-4">
              ...
              {layout === "cron-native" ? (
                ...
                <div className={`grid ${showSeconds ? 'grid-cols-3' : 'grid-cols-2'} gap-4`}>
                  {showSeconds && (
                    <FieldLabelWithInfo
                      label="Second (0-59)"
                        ...
                        <div className="flex rounded-md overflow-hidden border">
                          <button
                            ...
                            className={`px-2 py-1 text-xs font-medium transition-colors ${
                              dayMode === "everyday" ? theme.primaryColor : `${theme.secondaryColor} hover:bg-muted/80`
                            }`}
                          ...
                          <button
                            ...
                            className={`px-2 py-1 text-xs font-medium transition-colors border-l ${
                              dayMode === "dayOfWeek" ? theme.primaryColor : `${theme.secondaryColor} hover:bg-muted/80`
                            }`}
